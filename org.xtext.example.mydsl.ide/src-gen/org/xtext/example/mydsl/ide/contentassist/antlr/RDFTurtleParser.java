...
import org.xtext.example.mydsl.ide.contentassist.antlr.internal.InternalRDFTurtleParser;
import org.xtext.example.mydsl.services.RDFTurtleGrammarAccess;

public class RDFTurtleParser extends AbstractContentAssistParser {
	...
	public static final class NameMappings {
		...
		@Inject
		public NameMappings(RDFTurtleGrammarAccess grammarAccess) {
		...
		private static void init(ImmutableMap.Builder<AbstractElement, String> builder, RDFTurtleGrammarAccess grammarAccess) {
			...
			builder.put(grammarAccess.getSparqlPrefixAccess().getGroup(), "rule__SparqlPrefix__Group__0");
			builder.put(grammarAccess.getSparqlBaseAccess().getGroup(), "rule__SparqlBase__Group__0");
			...
			builder.put(grammarAccess.getTurtleDocAccess().getStatementsAssignment(), "rule__TurtleDoc__StatementsAssignment");
			builder.put(grammarAccess.getStatementAccess().getDirectiveAssignment_0_0(), "rule__Statement__DirectiveAssignment_0_0");
			builder.put(grammarAccess.getStatementAccess().getTriplesAssignment_0_1(), "rule__Statement__TriplesAssignment_0_1");
			...
			builder.put(grammarAccess.getDirectiveAccess().getSparqlPrefixAssignment_2(), "rule__Directive__SparqlPrefixAssignment_2");
			builder.put(grammarAccess.getDirectiveAccess().getSparqlBaseAssignment_3(), "rule__Directive__SparqlBaseAssignment_3");
			builder.put(grammarAccess.getPrefixIDAccess().getPrefixNameAssignment_1(), "rule__PrefixID__PrefixNameAssignment_1");
			builder.put(grammarAccess.getPrefixIDAccess().getIrirefAssignment_2(), "rule__PrefixID__IrirefAssignment_2");
			builder.put(grammarAccess.getBaseAccess().getIrirefAssignment_1(), "rule__Base__IrirefAssignment_1");
			builder.put(grammarAccess.getSparqlPrefixAccess().getPrefixNameAssignment_1(), "rule__SparqlPrefix__PrefixNameAssignment_1");
			builder.put(grammarAccess.getSparqlPrefixAccess().getIrirefAssignment_2(), "rule__SparqlPrefix__IrirefAssignment_2");
			builder.put(grammarAccess.getSparqlBaseAccess().getIrirefAssignment_1(), "rule__SparqlBase__IrirefAssignment_1");
			...
			builder.put(grammarAccess.getIResourceAccess().getIriRefAssignment_0(), "rule__IResource__IriRefAssignment_0");
	...
	@Override
	protected InternalRDFTurtleParser createParser() {
		InternalRDFTurtleParser result = new InternalRDFTurtleParser(null);
