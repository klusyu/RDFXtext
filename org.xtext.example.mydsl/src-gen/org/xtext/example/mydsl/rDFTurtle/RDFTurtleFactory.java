 ...
 * @generated
 */
public interface RDFTurtleFactory extends EFactory
{
  /**
   ...
   * @generated
   */
  RDFTurtleFactory eINSTANCE = org.xtext.example.mydsl.rDFTurtle.impl.RDFTurtleFactoryImpl.init();

  /**
   * Returns a new object of class '<em>Turtle Doc</em>'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @return a new object of class '<em>Turtle Doc</em>'.
   * @generated
   */
  TurtleDoc createTurtleDoc();
  ...
  /**
   * Returns a new object of class '<em>Sparql Prefix</em>'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @return a new object of class '<em>Sparql Prefix</em>'.
   * @generated
   */
  SparqlPrefix createSparqlPrefix();

  /**
   * Returns a new object of class '<em>Sparql Base</em>'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @return a new object of class '<em>Sparql Base</em>'.
   * @generated
   */
  SparqlBase createSparqlBase();
   ...
   * @generated
   */
  RDFTurtlePackage getRDFTurtlePackage();
