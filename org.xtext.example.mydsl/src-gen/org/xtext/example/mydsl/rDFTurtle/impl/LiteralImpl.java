 ...
 * </p>
 * <ul>
 *   <li>{@link org.xtext.example.mydsl.rDFTurtle.impl.LiteralImpl#getLanguageString <em>Language String</em>}</li>
 *   <li>{@link org.xtext.example.mydsl.rDFTurtle.impl.LiteralImpl#getDatatypeString <em>Datatype String</em>}</li>
 *   <li>{@link org.xtext.example.mydsl.rDFTurtle.impl.LiteralImpl#getDword <em>Dword</em>}</li>
 *   <li>{@link org.xtext.example.mydsl.rDFTurtle.impl.LiteralImpl#getReal <em>Real</em>}</li>
 *   <li>{@link org.xtext.example.mydsl.rDFTurtle.impl.LiteralImpl#getDecimal <em>Decimal</em>}</li>
 *   <li>{@link org.xtext.example.mydsl.rDFTurtle.impl.LiteralImpl#getBool <em>Bool</em>}</li>
 * </ul>
 *
 * @generated
 */
public class LiteralImpl extends MinimalEObjectImpl.Container implements Literal
{
  ...
  {
    return RDFTurtlePackage.Literals.LITERAL;
  }
  ...
  public NotificationChain basicSetLanguageString(LanguageString newLanguageString, NotificationChain msgs)
  {
    ...
    {
      ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, RDFTurtlePackage.LITERAL__LANGUAGE_STRING, oldLanguageString, newLanguageString);
  ...
  public void setLanguageString(LanguageString newLanguageString)
  {
    if (newLanguageString != languageString)
    {
      ...
      if (languageString != null)
        msgs = ((InternalEObject)languageString).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - RDFTurtlePackage.LITERAL__LANGUAGE_STRING, null, msgs);
      if (newLanguageString != null)
        msgs = ((InternalEObject)newLanguageString).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - RDFTurtlePackage.LITERAL__LANGUAGE_STRING, null, msgs);
      msgs = basicSetLanguageString(newLanguageString, msgs);
      if (msgs != null) msgs.dispatch();
    }
    else if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, RDFTurtlePackage.LITERAL__LANGUAGE_STRING, newLanguageString, newLanguageString));
  }
  ...
  public NotificationChain basicSetDatatypeString(DatatypeString newDatatypeString, NotificationChain msgs)
  {
    ...
    if (eNotificationRequired())
    {
      ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, RDFTurtlePackage.LITERAL__DATATYPE_STRING, oldDatatypeString, newDatatypeString);
      if (msgs == null) msgs = notification; else msgs.add(notification);
    }
    return msgs;
  }
  ...
  public void setDatatypeString(DatatypeString newDatatypeString)
  {
    if (newDatatypeString != datatypeString)
    {
      ...
      if (datatypeString != null)
        msgs = ((InternalEObject)datatypeString).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - RDFTurtlePackage.LITERAL__DATATYPE_STRING, null, msgs);
      if (newDatatypeString != null)
        msgs = ((InternalEObject)newDatatypeString).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - RDFTurtlePackage.LITERAL__DATATYPE_STRING, null, msgs);
      msgs = basicSetDatatypeString(newDatatypeString, msgs);
      if (msgs != null) msgs.dispatch();
    }
    else if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, RDFTurtlePackage.LITERAL__DATATYPE_STRING, newDatatypeString, newDatatypeString));
  }
  ...
  public void setDword(int newDword)
  {
    ...
    dword = newDword;
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, RDFTurtlePackage.LITERAL__DWORD, oldDword, dword));
  }
  ...
  public void setReal(String newReal)
  {
    ...
    real = newReal;
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, RDFTurtlePackage.LITERAL__REAL, oldReal, real));
  }
  ...
  public void setDecimal(String newDecimal)
  {
    ...
    decimal = newDecimal;
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, RDFTurtlePackage.LITERAL__DECIMAL, oldDecimal, decimal));
  }
  ...
  public void setBool(String newBool)
  {
    ...
    bool = newBool;
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, RDFTurtlePackage.LITERAL__BOOL, oldBool, bool));
  }
  ...
  public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs)
  {
    switch (featureID)
    {
      case RDFTurtlePackage.LITERAL__LANGUAGE_STRING:
        return basicSetLanguageString(null, msgs);
      case RDFTurtlePackage.LITERAL__DATATYPE_STRING:
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
    switch (featureID)
    {
      ...
      case RDFTurtlePackage.LITERAL__DWORD:
        return getDword();
      case RDFTurtlePackage.LITERAL__REAL:
        return getReal();
      case RDFTurtlePackage.LITERAL__DECIMAL:
        return getDecimal();
      case RDFTurtlePackage.LITERAL__BOOL:
        return getBool();
    }
