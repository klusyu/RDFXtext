...
// Entry rule entryRuleTurtleDoc
entryRuleTurtleDoc returns [EObject current=null]:
	{ newCompositeNode(grammarAccess.getTurtleDocRule()); }
	iv_ruleTurtleDoc=ruleTurtleDoc
	{ $current=$iv_ruleTurtleDoc.current; }
	EOF;

// Rule TurtleDoc
ruleTurtleDoc returns [EObject current=null]
@init {
	enterRule();
}
@after {
...
// Entry rule entryRuleSparqlPrefix
entryRuleSparqlPrefix returns [EObject current=null]:
	{ newCompositeNode(grammarAccess.getSparqlPrefixRule()); }
	iv_ruleSparqlPrefix=ruleSparqlPrefix
	{ $current=$iv_ruleSparqlPrefix.current; }
	EOF;

// Rule SparqlPrefix
ruleSparqlPrefix returns [EObject current=null]
@init {
	enterRule();
}
@after {
...
// Entry rule entryRuleSparqlBase
entryRuleSparqlBase returns [EObject current=null]:
	{ newCompositeNode(grammarAccess.getSparqlBaseRule()); }
	iv_ruleSparqlBase=ruleSparqlBase
	{ $current=$iv_ruleSparqlBase.current; }
	EOF;

// Rule SparqlBase
ruleSparqlBase returns [EObject current=null]
@init {
	enterRule();
}
@after {
...
RULE_IRIREF : '<' ( options {greedy=false;} : . )*'>';
